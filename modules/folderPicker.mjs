    ...
    connectedCallback() {
        ...
        style.textContent = `
            @media (prefers-color-scheme: dark) {
               :host {
                    --border-color: color-mix(in srgb, var(--background-color-box) 95%, black);
                    ...
                    --selected-color: color-mix(in srgb, var(--background-color-box) 95%, white);
                }
            }
            @media (prefers-color-scheme: light) {
                :host {
                    --border-color: color-mix(in srgb, var(--background-color-box) 95%, white);
                    ...
                    --selected-color: color-mix(in srgb, var(--background-color-box) 95%, black);
